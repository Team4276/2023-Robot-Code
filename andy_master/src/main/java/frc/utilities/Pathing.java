...
public class Pathing {
    ...
    public static List<Double> receivePath() {
        Vector3 target = new Vector3(SmartDashboard.getNumber("X target", 0), SmartDashboard.getNumber("Y target", 0),
                SmartDashboard.getNumber("Z target", 0));
        ...
        try {
            ...
            // get distance
            double distance = table.getEntry("Distance").getDouble(0); // gets the distance of the path (note this is
                                                                       // not the direct distance to the target just the
                                                                       // length of the path)
            // System.out.print("3");
