...
public class AutoDrivetrain {
    ...
    private static CANSparkMax FR_motor = Drivetrain.frDriveX;
    private static CANSparkMax FL_motor = Drivetrain.flDriveX;
    private static CANSparkMax BR_motor = Drivetrain.brDriveX;
    private static CANSparkMax BL_motor = Drivetrain.blDriveX;
