...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    autoMode = createSmartDashboardString("Auto Mode Input: ", "0");
  ...
  public void robotPeriodic() {
    autoMode = SmartDashboard.getString("Auto Mode Input: ", "*****");
    SmartDashboard.putString("Auto Mode Show: ", autoMode);
  }
  ...
  /** Initialize value on SmartDashboard fror user input, but leave old value if already present */
  public static String createSmartDashboardString(String key, String defValue) {
    String val = defValue;
    try {
      val = SmartDashboard.getString(key, defValue);
