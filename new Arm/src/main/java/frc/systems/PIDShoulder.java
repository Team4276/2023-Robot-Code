...
public class PIDShoulder {
    ...
    private static void setShoulderSpeedPID(double speed) {
        driveShoulder_R.getPIDController().setReference(speed, CANSparkMax.ControlType.kSmartVelocity);
    }
    ...
    public static void PIDShoulderUpdate() {
        ...
        if (Math.abs(Robot.xboxController.getRightY()) < deadband){
            ...
            double power = Robot.xboxController.getRightY() * 50;

            setShoulderSpeed(power);
        ...
        SmartDashboard.putNumber("Right Joystick Output", Robot.xboxController.getRightY());
        System.out.print("Right Power");
        System.out.println(driveShoulder_R.getAppliedOutput());
        System.out.print("Left Power");
        System.out.println(driveShoulder_L.getAppliedOutput());
    }
}
