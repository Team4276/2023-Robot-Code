...
public class Drivetrain {
    ...
    static private Encoder m_left_encoder;
    static private Encoder m_right_encoder;
    ...
    static public double getLeftEncoderDistance() {
        double leftDistance = m_left_encoder.getDistance();

        return leftDistance;

    }

    static public double getRightEncoderDistance() {
        double rightDistance = m_right_encoder.getDistance();
