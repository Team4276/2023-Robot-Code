...
public class PID {
	...
	private static double maxOutput = 10000;
	private static double minOutput = -10000;

	private static double setpoint1 = 0;

	private static double lastActual = 0;

	private static boolean firstRun = true;
	private boolean reversed = false;

	private static double outputRampRate = 0;
	private static double lastOutput = 0;

	private static double outputFilter = 0;

	private static double setpointRange = 0;
	 ...
	 */
	public void MiniPID(double p, double i, double d) {
		P = p;
		I = i;
		D = d;
		checkSigns();
	 ...
	 */
	public void MiniPID(double p, double i, double d, double f) {
		P = p;
		I = i;
		D = d;
		F = f;
	 ...
	 * always gets to the control mode.
	 * Typically tuned second for "Position" based modes, and third for "Rate" or
	 ...
	 * However, in many systems a large D value will cause significant instability,
	 * particularly
	 ...
	 */
	public static double getOutput(double actual, double setpoint) {
		double output;
		double Poutput;
		double Ioutput;
		double Doutput;
	...
	public double getOutput() {
		return getOutput(lastActual, setpoint1);
	}
	...
	public double getOutput(double actual) {
		return getOutput(actual, setpoint1);
	}
	 ...
	 * more heavily, with low values weigh newer data. 0 will disable, filtering,
	 * and use
