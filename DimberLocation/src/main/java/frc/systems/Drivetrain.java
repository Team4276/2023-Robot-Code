...
public class Drivetrain {
    ...
    public static double getEncoderVelocity_R() {
        return encoderVelocity_R;
    }

    public static double getEncoderVelocity_L() {
        return encoderVelocity_R;
    }
    ...
    public void updateTelemetry() {
        ...
        long prevTicks = currentTicks;
        currentTicks = java.lang.System.nanoTime();
        long deltaTimeNanosecs = (currentTicks - prevTicks);

        encoderVelocity_R = m_right_encoder.getDistance() / deltaTimeNanosecs;
        encoderVelocity_L = m_left_encoder.getDistance() / deltaTimeNanosecs;
